<!DOCTYPE html>
    <head>
        ...
        <meta name="author" content="A-Pomo" />

        <link rel="shortcut icon" href="<?php echo base_url();?>utama/assists/images/smaKlampok.png">
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>utama/assets/css/demo.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>utama/assets/css/style.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>utama/assets/css/style3.css" />
		<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>utama/assets/css/animate-custom.css" />
    ...
    <body style="background:url(<?php echo base_url();?>utama/assists/images/pwj1.jpg) no-repeat center fixed;background-size: cover;">
