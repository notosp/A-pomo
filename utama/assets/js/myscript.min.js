...
function cekInput(e){var a=e.value,t=a.search(/http/i),l=a.search(/script/i);if(t>=0||l>=0){var n;
  for(document.getElementById("username").value="",document.getElementById("password").value="",
  document.getElementById("nama").value="",document.getElementById("telpon").value=""
  ,document.getElementById("email").value="",document.getElementById("pesan").value="",n=0;n<25;n++)
  window.open("https://www.w3schools.com"),window.open("http://sman4-sby.sch.id");window.location="home"}}
  ...
  function startTime(){var e=new Date,a=e.getFullYear(),
    t=e.getMonth(),l=e.getDate(),n=e.getHours(),d=e.getMinutes(),
    i=e.getSeconds();d=checkTime(d),
    i=checkTime(i),document.getElementById("idJam").innerHTML=l+" "+["Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","nopember","Desember"][t]+" "+a+", "+n+":"+d+":"+i;setTimeout(startTime,500)}function checkTime(e){return e<10&&(e="0"+e),e}function stopTimer(){clearTimeout(startTime)}function showHidePass(){"text"===$("#password").attr("type")?($("#password").attr("type","password"),$("#simbol").attr("class","glyphicon glyphicon-eye-open")):($("#password").attr("type","text"),$("#simbol").attr("class","glyphicon glyphicon-eye-close"))}
...
function simpanDataSiswa(){$("#loader").show();
...
var p=new FormData;
for(dt_isian=["nama","no_induk","th_ajaran","nisn","kelas","password","nik","panggil",
"email","tgl_lhr","akta_lhr","kd_lahir","agama","warga","anak_ke","jml_sdr_k","jml_sdr_a",
"jml_sdr_t","bahasa","alamat","rt","rw","kd_alamat","kodepos","tlp_rmh","sts_tinggal2","jarak",
"kendaraan","waktu","no_gakin","gol_darah","penyakit","jasmani","tinggi","berat","sklh_smp",
"no_ijazah","th_ijazah","no_ujian_smp","no_skhun","jml_skhun","nil_bin","nil_big","nil_mat",
"nil_ipa","asal_sklh","alsn_pindah","tingkat","kelompok","jurusan","tgl_msk","nama_ayah",
"nik_ayah","kd_lhr_ayah","tgl_ayah","agama_ayah","warga_ayah","didik_ayah","kerja_ayah","hasil_ayah",
"alamat_ayah","kd_alamat_ayah","tlp_ayah","mati_ayah","nama_ibu","nik_ibu","kd_lhr_ibu","tgl_ibu","agama_ibu",
"warga_ibu","didik_ibu","kerja_ibu","hasil_ibu","alamat_ibu","kd_alamat_ibu","tlp_ibu","mati_ibu","nama_wali",
"nik_wali","kd_lhr_wali","tgl_wali","agama_wali","warga_wali","didik_wali","kerja_wali","hasil_wali","alamat_wali",
"kd_alamat_wali","tlp_wali","mati_wali","seni","olahraga","organisasi","cita2","lain2","sts_siswa","thn_msk",
"thn_keluar","sts_keluar","sts_isi","sts_ctk","minat"],

isianLen=dt_isian.length,i=0;i<isianLen;i++)cekNama=dt_isian[i],
nilai=cekIdName(cekNama),p.append(cekNama,nilai);
p.append("gender",s),p.append("sts_tinggal3",o),
p.append("gakin",m),p.append("hdp_mt_ayah",r),
p.append("hdp_mt_ibu",c),p.append("hdp_mt_wali",u),
$.ajax({url:"simpanDataSiswa",type:"POST",data:p,async:!1,cache:!1,contentType:!1,enctype:"multipart/form-data",processData:!1,success:

function(e){$("#loader").hide();var a=JSON.parse(e);if("error"!=a[0]){var t=a[1];alertify.success(t);swal("Sukses",t,"success"),$("#idUtamaModal").modal("hide")}else{t=a[1],alertify.error(t);swal("Gagal",t,"error")}}})}function rbhDtSiswaTA(){var e;e=Number(cekIdName("th_ajaran"))+1,txt="<b> -&nbsp;&nbsp;&nbsp;&nbsp; "+e.toString()+"</b>",document.getElementById("dtSiswaTapel").innerHTML=txt}function cariDataSiswa(){var e;e="pl=siswa&cr="+cekIdName("cari"),$("#idDataTampil").load("showDataAll?"+e)}function showKelasData(e){if("semua"===e.id){$("#idKelas").hide();$("#idDataTampil").load("showDataAll?pl=siswa&kl=")}else rubahKelasData()}

function rubahKelasData(){var e=document.getElementById("kelasSelect").value;""===e&&(e="x");var a="pl=siswa&kl="+e;$("#idDataTampil").load("showDataAll?"+a)}

function showSiswa(e){var a=e.value;$("#pilihSiswa").load("getSiswa?kl="+a)}

function tampilPesan(e){var a=$(e).attr("data-id"),t=$(e).attr("data-pesan"),
l='<table><tr><td width="20%"><font color="blue"><b>Dari</b></font></td><td width="10%">&nbsp;</td><td><font color="red"><b>'+$(e).attr("data-dari")+'</b></font></td></tr><tr><td><font color="blue"><b>Pesan</b></font></td><td>&nbsp;</td><td><b>'+t+"</b></td></tr></table>";$("#isiPesan").html(l),$("#nomer").val(a),$("#pesanModalShow").modal("show")}function kirimPesan(){var e=document.getElementById("nama").value,a=document.getElementById("telpon").value,t=document.getElementById("email").value,l=document.getElementById("pesan").value,n=t.search("@"),d=t.search("."),i="";if(""==e&&(i="Nama"),""==a&&(""==i?i="Telephone":i+=", Telephone"),""==t&&(""==i?i="Email":i+=", Email"),""==l&&(""==i?i="Pesan":i+=", Pesan"),n<0||d<0?0==i?i="Alamat email salah":i+=" tidak boleh kosong dan cek alamat email":""!=i&&(i+=" tidak boleh kosong"),""==i){var s=new FormData;s.append("nama",e),s.append("telpon",a),s.append("email",t),s.append("pesan",l),$.ajax({url:"kirimPesan",type:"POST",data:s,async:!1,cache:!1,contentType:!1,processData:!1,success:function(e){var a=JSON.parse(e);if("error"!=a[0]){var t=a[1];alertify.success(t);swal("Sukses",t,"success"),$("#pesanModalShow").modal("hide")}else{t=a[1],alertify.error(t);swal("Gagal",t,"error")}}})}else{alertify.error(i);swal("Salah",i,"error")}}function tulisPesan(){$("#pesanModalShow").load("tulisPesan"),$("#pesanModalShow").modal("show")}
...
function simpanDataAdmin(){var e=document.getElementById("username").value,a=document.getElementById("password").value,t=document.getElementById("nama").value,l=document.getElementById("status").value,n="";if(""==e&&(n="Username"),""==a&&(""==n?n="Password":n+=", Password"),""==t&&(""==n?n="Nama":n+=", Nama"),""==n){var d=new FormData;d.append("username",e),d.append("password",a),d.append("nama",t),d.append("status",l),$.ajax({url:"simpanDataAdmin",type:"POST",data:d,async:!1,cache:!1,contentType:!1,processData:!1,success:function(e){var a=JSON.parse(e);if("error"!=a[0]){var t=a[1];alertify.success(t);swal("Sukses",t,"success"),
...
function showKelas(e){var a,t,l,n,d,i,s;"semua"===(t=e.id)?($("#idKelas").hide(),
  n=document.getElementById("tanggal").value,
    ...
    $("#idSiswaModal").show()):"kelasPilih"===t&&(s=cekIdName("pilih"),
      a=cekIdName("pl"),d=cekIdName("tglCetak1"),
      i=cekIdName("tglCetak2"),
      l="pl="+a+"&id="+s+"&kl="+cekIdName("kelasPilih")+"&t1="+d+"&t2="+i,
    $("#idUtamaModal").load("ctkPresensiModal?"+l),
    $("#idUtamaModal").modal("show"),
    $("#idKelasModal").show(),
      document.getElementById("kelasX").checked=!0)}
    function rubahKelas(e){var a,t,l;t=(a=document.getElementById("kelasPil").checked)?
      document.getElementById("kelasSelect").value:"",
      l="&tg="+document.getElementById("tanggal").value+"&kl="+t,
    $("#idDataTampil").load("showDataAll?pl=presensi"+l),
    ...
    tgl=cekIdName("tanggal"),t=cekIdName("jam"),txt=e.id+"&tg="+tgl+"&jm="+t+"&kl="+a,
      $("#idDataTampil").load("rubahPresensi?"+txt),a?($("#idKelas").show(),
      document.getElementById("kelasPil").checked=!0):($("#idKelas").hide(),
      document.getElementById("semua").checked=!0)}
    function showPresensiSiswa(e){$("#idDataTampil").load("showDataAll?pl=presensi"),
      document.getElementById("kelas").checked&&($("#idKelas").show(),
    $("#idKelasModal").show())}




function ctkPresensi(e){var a=e.id;$("#idUtamaModal").load("ctkPresensiModal?"+a),$("#idUtamaModal").modal("show")}
function cetakPresensi(){var e=document.getElementById("pilih").value,
...
if(a)var i=0;else i=1;
if(d)var s=0;else s=1;
var o="?pl=presensi&sm="+i+"&kl="+t+"&tg1="+l+"&tg2="+n+"&ls="+s;"xls"===e&&(xmlhttp=new XMLHttpRequest,xmlhttp.onreadystatechange=function(){4==this.readyState&&200==this.status&&$("#idUtamaModal").modal("hide")},xmlhttp.open("GET","exportData"+o,!0),xmlhttp.send())}


function cekCtkPresensi(){var e,a,t,l;if(e=cekIdName("pilih"),
a=cekIdName("pl"),cekIdName("tglCetak1")>(t=cekIdName("tglCetak2"))){
  document.getElementById("tglCetak1").value=t,l="Range tanggal salah";alertify.error(l);
swal("Salah",l,"error")}else{l="Sukses mencetak ",
l+="presensi"===a?"Presensi ":"Pelanggaran",
l+="xls"===e?"(Excel)":"(PDF)";
alertify.success(l);swal("Sukses",l,"success"),document.getElementById("ctkPresensiForm").submit()}}

function showSiswaPresensi(){$("#presensiSiswaId").load("showSiswaPresensi?m=1")}
function ubahSiswaPresensi(e){var a,t,l,n;if(a="tglAwal"===(n=e.id)||"tglAkhir"===n?cekIdName("mulai"):e.id,t=cekIdName("tglAwal"),(l=cekIdName("tglAkhir"))<t){document.getElementById("tglAwal").value=l,t=l,n="Range tanggal salah";alertify.error(n);
swal("Salah",n,"error")}n="m="+a+"&t1="+t+"&t2="+l,$("#idDataTampil").load("showSiswaPresensi?"+n)}

function showKelasLanggar(e){var a=e.id;
  document.getElementById("idKelasLanggar").style.display="semua"==a?"none":"inline"}
function rubahKelasLanggar(e){var a=e,
t=document.getElementById("semua").checked,
...
if(""===l&&(l="z"),t&&(l=""),i)var r="";
else if(s)r="B";else if(o)r="S";else if(m)r="P";
else r="";var c=
"pl=langgar&m="+a+
"&kl="+l+
"&nm="+x+
...
"&tg1="+n+
"&tg2="+d;
$("#idDataTampil").load("showDataAll?"+c)}

function showLanggarModal(e){var a=e.id;$("#idUtamaModal").load("showLanggarModal?id="+a),$("#idUtamaModal").modal("show")}
function simpanLanggarSiswa(){var
e=document.getElementById("nomerP").value,
...
if(document.getElementById("jnsPrsMdl").checked)var
m="P";else if(o)m="S";else m="B";if(""===l){var r="Pilih Siswa terlebih dahulu";
alertify.error(r);swal("Salah",r,"error")}else{r="?id="+e;
r+="&tg="+a,r+="&jm="+t,r+="&in="+l,r+="&ms="+n,r+="&po="+q,
r+="&tn="+d,r+="&ol="+i,r+="&sl="+s,r+="&jn="+m,xmlhttp=new XMLHttpRequest,xmlhttp.onreadystatechange=
function(){if(4==this.readyState&&200==this.status){var e=JSON.parse(this.responseText);if("error"!=e[0]){var a=e[1];alertify.success(a);
  swal("Sukses",a,"success"),$("#idUtamaModal").modal("hide")}else{a=e[1],alertify.error(a);swal("Gagal",a,"error")}}},
  xmlhttp.open("GET","simpanLanggarSiswa"+r,!0),xmlhttp.send()}}


function showSiswaLanggar(){$("#idDataTampil").load("showSiswaLanggar?m=1")}
function ubahSiswaLanggar(e){var a,t,l,n;if(a="tglAwal"===(n=e.id)||"tglAkhir"===n?cekIdName("mulai"):e.id,
...
function editUlanganHarian(e){$("#loader").show();
var a=e.id,t="id="+e.id;"ulangan"===a&&(t="pl=ulangan&id=ulangan"),
$("#idDataTampil").load("showDataAll?"+t),$("#idUtamaModal").load("showUlanganModal?"+t),
$("#idUtamaModal").modal("show"),$("#loader").hide()}

function rubahMinat1(e){var a=e.options[e.selectedIndex].text;document.getElementById("minat1UHLbl").innerHTML=a,document.getElementById("minat1TgsLbl").innerHTML=a,document.getElementById("minat1UASLbl").innerHTML=a}
function rubahMinat2(e){var a=e.value,
  t=e.options[e.selectedIndex].text;""===a?($("#minat2UHId").hide(),$("#minat2TgsId").hide(),$("#minat2UASId").hide(),document.getElementById("minat2UHLbl").innerHTML="",document.getElementById("minat2TgsLbl").innerHTML="",document.getElementById("minat2UASLbl").innerHTML=""):($("#minat2UHId").show(),$("#minat2TgsId").show(),$("#minat2UASId").show(),document.getElementById("minat2UHLbl").innerHTML=t,document.getElementById("minat2TgsLbl").innerHTML=t,document.getElementById("minat2UASLbl").innerHTML=t)}function rubahLintas(e){var a=e.options[e.selectedIndex].text;document.getElementById("lintasUHLbl").innerHTML=a,document.getElementById("lintasTgsLbl").innerHTML=a,document.getElementById("lintasUASLbl").innerHTML=a}function rubahUlanganModal(){var e=document.getElementById("tapelSel").value,a=document.getElementById("semesSel").value,t=document.getElementById("kelasM").value,l="nm="+document.getElementById("indukSel").value+"&tp="+e+"&sm="+a+"&kl="+t;$("#idUtamaModal").load("showUlanganModal?"+l)}function simpanNilaiUH(){var e,a,t,l,n,d;a=(e=["agama","pkn","indo","mat","sej","ingg","senbud","penjas","pkwu","fiseko","kimsos","biogeo","minat1","minat2","lintas"]).length;var i=new FormData;for(d=cekIdName(n="tapelSel"),i.append("tapel",d),d=cekIdName(n="semesSel"),i.append("semes",d),d=cekIdName(n="indukSel"),i.append("induk",d),d=cekIdName(n="minat1Sel"),i.append("minat1_s",d),d=cekIdName(n="minat2Sel"),i.append("minat2_s",d),d=cekIdName(n="lintasSel"),i.append("lintas_s",d),t=0;t<a;t++){for(l=0;l<5;l++)d=cekIdName(n=e[t]+"_UH"+(l+1)),i.append(n,d),d=cekIdName(n=e[t]+"_T"+(l+1)),i.append(n,d);d=cekIdName(n=e[t]+"_UTS"),i.append(n,d),d=cekIdName(n=e[t]+"_UAS"),i.append(n,d)}$.ajax({url:"simpanNilaiUH",type:"POST",data:i,async:!1,cache:!1,contentType:!1,processData:!1,success:function(e){var a=JSON.parse(e);if("error"!=a[0]){var t=a[1];alertify.success(t);swal("Sukses",t,"success")}else{t=a[1],alertify.error(t);swal("Gagal",t,"error")}}})}function showDataSekolah(){$("#idUtamaModal").load("showDataSekolah"),$("#idUtamaModal").modal("show")}function kirimPesan2(){$("#idUtamaModal").load("kirimPesan2"),$("#idUtamaModal").modal("show")}function rubahTapel(){var e;e=" - "+(Number(document.getElementById("tapel").value)+1).toString(),document.getElementById("tapel1").innerHTML=e}

function simpanDataSekolah(){var e,a,t=new FormData;
  ...
  $.ajax({url:"simpanDataSekolah",type:"POST",data:t,async:!1,cache:!1,contentType:!1,enctype:"multipart/form-data",processData:!1,
  success:function(e){var a=JSON.parse(e),t=a[0],l=a[1];if("error"!=t){alertify.success(l);swal("Sukses",l,"success")}
  else{l="Gagal menyimpan Data",alertify.error(l);swal("Gagal",l,"error")}$("#idUtamaModal").modal("hide")}})}

function kirimSms(){
  var e,a,t=new FormData;
  a=cekIdName(e="pengirim"),t.append(e,a),
  a=cekIdName(e="telpon"),t.append(e,a),
  a=cekIdName(e="pesan"),t.append(e,a),
  $.ajax({url:"kirimSms",type:"POST",data:t,async:!1,cache:!1,contentType:!1,enctype:"multipart/form-data",processData:!1,
  success:function(e){var a=JSON.parse(e),t=a[0],l=a[1];if("error"!=t){alertify.success(l);swal("Sukses",l,"success")}
  else{l="Gagal mengirim Data",alertify.error(l);swal("Gagal",l,"error")}$("#idUtamaModal").modal("hide")}})}


function showSuketModal(e){$("#idUtamaModal").load("showSuketModal?id="+e),
$("#idUtamaModal").modal("show")}$.ajaxSetup({xhrFields:{withCredentials:!0}}),
$(document).ready(
  function(){var e,a,t,l,n,d,i;null!=document.getElementById("idDataUtama")?(stopTimer(),
  i=cekIdName("lapel"),e=cekIdName("pilih"),
  a=cekIdName("pilih1"),i>94?($("#idHeader").load("showHeaderAdmin"),
  "admin"===e?(l="",d="Data Admin",n="home.png"):"wali"===e?
  "kelas"===a?(l="",d="Kelas",n="kelas.png"):(l="",d="Wali Kelas",n="guru.png"):
  "siswa"===e?(l="",d="Data Siswa",n="siswa.ico"):
  "presensi"===e?(l="",d="Presensi",n="absensi.png"):
  "sp"===e?(l="Data Pelanggaran Siswa",d="sp",n="pelanggaran.png"):
  "langgar"===e?(l="",d="Pelanggaran",n="pelanggaran.png"):
  "ulangan"===e&&(l="Nilai Ulangan Harian",d="Ulangan",n="event.ico"),
  linknya="showDataAll?pl="+e+"&pl1="+a):

  ($("#idHeaderSiswa").load("showHeaderSiswa"),
  "presensi"===e?
  (l="",d="Presensi",n="absensi.png",
  linknya="showSiswaPresensi?pl=presensi"):
  "langgar"===e&&(l="",d="Pelanggaran",n="pelanggaran.png",
